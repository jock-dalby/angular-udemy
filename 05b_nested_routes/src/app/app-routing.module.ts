...
const appRoutes: Routes = [
    ...
    {path: '**', redirectTo: '/not-found'} // ** wild card route which means catch all routes you don't know. IMPORTANT: THIS NEEDS TO BE THE LAST ROUTE IN THE ROUTES ARRAY AS THEY GET CHECKED TOP TO BOTTOM.
];
